    ...
    public class PersonasImpl
    {
        ...
        public int PersonasAdd(Personas oPersona)
		{
			try
			{
                ...
                ds = new DataSet();
                cmd = new OracleCommand("insert into Personas( PRS_APELLIDO, PRS_NOMBRE," +
                    "PRS_ESTADO_CIVIL, PRS_TIPO_DOC, PRS_NUMERO_DOC, PRS_SEXO, PRS_FECHA_NACIMIENTO, " +
                    "LOC_NUMERO_NACIMIENTO, PRS_FECHA_INGRESO, PRS_FECHA_BAJA, " +
                    "EST_CODIGO, PRS_MOTIVO_BAJA, PRS_LEGAJO, PRS_CUIL, PRS_CARGO) " +
                    "values( '"+oPersona.PrsApellido + "', '"+oPersona.PrsNombre + "', '" + 
                    oPersona.PrsEstadoCivil + "', '" + oPersona.PrsTipoDoc + "', '" + oPersona.PrsNumeroDoc + "', '" + 
                    oPersona.PrsSexo + "', " + oPersona.PrsFechaNacimiento + ", " + oPersona.LocNumeroNacimiento + ", " + oPersona.PrsFechaIngreso + ", " + 
                    oPersona.PrsFechaBaja + ", '" + oPersona.EstCodigo + "', '" + oPersona.PrsMotivoBaja + "', " + 
                    oPersona.PrsLegajo + ", '" + oPersona.PrsCuil + "', '" + oPersona.PrsCargo + "')", cn);
        ...
        public bool PersonasUpdate(Personas oPersona)
		{
			try
			{
                ...
                cmd = new OracleCommand("update Personas " +
                    "SET PRS_APELLIDO='" + oPersona.PrsApellido + "'," +
                    ...
                    "PRS_FECHA_NACIMIENTO=" + oPersona.PrsFechaNacimiento + ", " +
                    "LOC_NUMERO_NACIMIENTO=" + oPersona.LocNumeroNacimiento + ", " + 
                    "PRS_FECHA_INGRESO=" + oPersona.PrsFechaIngreso + ", " + 
                    "PRS_FECHA_BAJA=" + oPersona.PrsFechaBaja + ", " + 
