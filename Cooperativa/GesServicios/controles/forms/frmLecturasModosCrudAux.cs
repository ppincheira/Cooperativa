...
{
    public partial class frmLecturasModosCrudAux : gesForm, IVistaLecturasModosCrud
    {
        ...
        public frmLecturasModosCrudAux()
        {
            InitializeComponent();
        }

        public frmLecturasModosCrudAux(long NumeroLectura, string estado)
        {
            try
            {
